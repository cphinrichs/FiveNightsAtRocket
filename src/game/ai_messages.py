...
Go:""",
        ...
        personality_options = {
            ...
            'Angellica': [
                'productivity-focused, hates Solitaire slackers',
                'enforces strict coding discipline, no Solitaire allowed',
...
Short death message (max 15 words), darkly funny:""",
    ...
    def _get_fallback_message(self, enemy_name: str, context: dict) -> str:
        ...
        fallback_messages = {
            ...
            'Angellica': [
                "Angellica saw your Solitaire game. Your final hand is over.",
                "Solitaire? In THIS office? Angellica says no.",
                "Should've stuck to coding. Angellica doesn't tolerate slackers.",
                "Your productivity score: Zero. Forever.",
                "Angellica enforces the company's no-Solitaire policy. Permanently.",
            ],
            'Runnit': [
